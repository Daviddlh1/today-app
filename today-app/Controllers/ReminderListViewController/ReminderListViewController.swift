...
class ReminderListViewController: UICollectionViewController {
    ...
    override func viewDidLoad() {
        ...
        let headerRegistration = UICollectionView.SupplementaryRegistration(elementKind: ProgressHeaderView.elementKind, handler: supplementaryRegistration)
    ...
    private func supplementaryRegistration(progressView: ProgressHeaderView, elementKind: String, indexPath: IndexPath) {
